...
public class RadarView extends View {
    private int count = 6;                //蜘蛛网格中正多边形的个数
    private float angle = (float) (Math.PI*2/count);//Math.PI 记录的圆周率
    ...
    /**
     * 我们在onSizeChanged(int w, int h, int oldw, int oldh)方法里面，
     * 根据View的长宽，获取整个布局的中心坐标，因为整个雷达都是以整个中心开始绘制的。
     * @param w
     * @param h
     * @param oldw
     * @param oldh
     ...
     * 给每个末端加上这个距离以后，再绘制文本。另外，当文本在左边时，
